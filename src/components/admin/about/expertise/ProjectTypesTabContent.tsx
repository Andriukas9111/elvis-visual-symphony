...
const ProjectTypesTabContent: React.FC = () => {
  ...
  const updateMutation = useMutation({
    mutationFn: async (itemData: Partial<ProjectType> & { id: string }) => {
      const { data, error } = await supabase
        .from('project_types')
        .update(itemData)
        .eq('id', itemData.id)
  ...
  const createMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      toast({
        title: "Success",
        description: "New project type created successfully",
      });
    },
    onError: (error) => {
      ...
      toast({
        title: "Error",
        description: "Failed to create new project type",
        variant: "destructive"
      });
    }
  });
  ...
  const reorderMutation = useMutation({
    ...
    onError: (error) => {
      ...
      toast({
        title: "Error",
        description: "Failed to reorder project types",
        variant: "destructive"
      });
    }
  });
  ...
  const handleInputChange = (id: string, field: keyof ProjectType, value: string | number) => {
